---
title: 'Using your Deno Edge Server'
description: 'We use Deno for our edge server to handle WebSocket connections and realtime AI processing.'
icon: 'cloud'
---
...
<Warning>
 **Note**: Deno Dash is the legacy version of Deno Deploy. Elato is currently using Deno Dash. You can use Deno Deploy but be aware that it routes websocket connections via AWS which flips your websocket's RSV bits and can result in unknown opcodes for your ESP32.
</Warning>

1. **Deploy to Deno Dash**:

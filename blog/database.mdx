---
title: 'Using your Supabase DB'
description: 'We use Supabase for Auth, session management and storing character prompts, user preferences etc.'
icon: 'database'
---
...
<img src="/images/tables.png" alt="Supabase Tables Chart" width="100%" />
